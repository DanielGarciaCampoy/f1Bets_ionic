...
export class FirebaseWebService extends FirebaseService implements OnDestroy{
  ...
  async init(){
    const firebaseConfig = {
      apiKey: "AIzaSyC72Pwa0ObiKSBRQsRD9HjGebqH2HtHa9Y",
      authDomain: "f1bets-74760.firebaseapp.com",
      projectId: "f1bets-74760",
      storageBucket: "f1bets-74760.appspot.com",
      messagingSenderId: "996516886382",
      appId: "1:996516886382:web:54ca52da55f0b20086337f"
    };
  ...
  public async createUserWithEmailAndPassword(email: string, password: string): Promise<UserCredential> {
    return new Promise((resolve, reject) => {
      try {
        ...
        // Explicitly define the type of the error object
        const typedError: { code?: string, message?: string } = error;
